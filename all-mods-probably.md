...
#% increased Fire Damage per 1% Missing Fire Resistance
...
#% of Damage taken gained as Life over 4 seconds when Hit
...
Adds # to # Chaos Damage to Attacks per 50 Strength
...
An additional Currency Item drops when the first Invasion Boss is slain
...
Attacks with this Weapon deal #-# added Chaos Damage against\nEnemies affected by at least 5 Poisons
...
Bleeding Enemies you Kill Explode dealing #% of\ntheir Maximum Life as Physical Damage
...
Can have any Fossil modifiers (Tangled Fossil)
...
Chain Hook has +# Radius per 12 Rage
Chain Hook has a #% chance to grant +1 Rage if it Hits Enemies
...
Clarity has #% reduced Mana Reservation
...
Creates a mirrored copy (Fractured Fossil)
...
Drops Burning Ground while moving dealing # Fire Damage per second for # second
Drops Enchanted Boots (×#)
Drops Enchanted Gloves (×#)
Drops Itemised Prophecies (×#)
Drops Shocked Ground while moving lasting # seconds
Drops a 30% Quality Weapon (×#)
Drops a 6-linked Unique Body Armour (×#)
Drops a 6-linked Weapon (×#)
Drops a Beachhead Unique Map (×#)
Drops a Blighted Map (×#)
Drops a Breach Blessing (×#)
Drops a Breachstone (×#)
Drops a League-specific Unique Item (×#)
Drops a Map Item (×#)
Drops a Rare Weapon (×#)
Drops a Resonator (×#)
Drops a Shaper Weapon (×#)
Drops a Stygian Vise (×#)
Drops a Talisman Unique Item (×#)
Drops a Unique Item (×#)
Drops a Unique Weapon (×#)
Drops a Veiled Weapon (×#)
Drops a valuable Gem (×#)
Drops additional Abyssal Jewels (×#)
Drops additional Atlas Jewellery (×#)
Drops additional Blight Oils (×#)
Drops additional Breach Splinters (×#)
Drops additional Catalysts (×#)
Drops additional Currency Items (×#)
Drops additional Currency Shards (×#)
Drops additional Divination Cards (×#)
Drops additional Elder Armour (×#)
Drops additional Essences (×#)
Drops additional Fossils (×#)
Drops additional Gilded Scarabs (×#)
Drops additional Harbinger Currency (×#)
Drops additional Incursion Armour (×#)
Drops additional Incursion Jewellery (×#)
Drops additional Jewels (×#)
Drops additional Legion Incubators (×#)
Drops additional Map Fragments (×#)
Drops additional Maps (×#)
Drops additional Perandus Coins (×#)
Drops additional Polished Scarabs (×#)
Drops additional Quality Gems (×#)
Drops additional Rare Armour (×#)
Drops additional Rare Jewellery (×#)
Drops additional Rare Talismans (×#)
Drops additional Rare Weapons (×#)
Drops additional Rusted Scarabs (×#)
Drops additional Shaper Armour (×#)
Drops additional Shaper or Elder Jewellery (×#)
Drops additional Silver Coins (×#)
Drops additional Unique Armour (×#)
Drops additional Unique Items (×#)
Drops additional Unique Jewellery (×#)
Drops additional Veiled Armour (×#)
Drops additional Veiled Jewellery (×#)
Drops additional valuable Currency Shards (×#)
Drops an Abyss Unique Item (×#)
Drops an Abyssal Jewel (×#)
Drops an Elder Weapon (×#)
Drops an Enchanted Helmet (×#)
Drops an Incursion Weapon (×#)
Drops an Itemised Prophecy (×#)
...
Earthquake deals #% increased Damage per 0.1 seconds Duration
...
Enemies Cursed by you are Hindered with #% reduced Movement\nSpeed if 25% of Curse Duration expired
...
Enemies take #% increased Elemental Damage from your Hits for\neach Withered you have inflicted on them
...
Every 5 seconds Regenerate #% of Life over one second
...
Grants # to Dexterity per 2% Quality
Grants # to Intelligence per 2% Quality
Grants # to Maximum Life per 2% Quality
Grants # to Maximum Mana per 2% Quality
Grants # to Strength per 2% Quality
Grants #% increased Accuracy per 2% Quality
Grants #% increased Area of Effect per 4% Quality
Grants #% increased Elemental Damage per 2% Quality
Grants #% of Life Recovery to Minions
Grants #% to Cold Resistance per 2% Quality
Grants #% to Fire Resistance per 2% Quality
Grants #% to Lightning Resistance per 2% Quality
...
Has a Corrupt Essence modifier (Glyphic Fossil)
Has a Labyrinth Enchantment (Enchanted Fossil)
Has a Vaal modifier (Bloodstained Fossil)
Has an Abyssal socket (Hollow Fossil)
...
Haste has #% reduced Mana Reservation
...
Heist Chests have a #% chance to Duplicate contained Currency
...
Improved Quality (Perfect Fossil)
...
Item drops on Death if Equipped by an Animated Guardian
Item drops on Death if Equipped by an Animated Guardian
Item is overvalued by vendors (Gilded Fossil)
...
Lancing Steel has #% chance count as consumeing Steel Shards without Consuming them
Lancing Steel's additional Projectiles have #% chance to Impale Enemies
Lancing Steel's primary Projectile Pierces 1 additional Target
...
Monsters take #% reduced Extra Damage from Critical Strikes
Monsters with Silver Coins drop an additional Currency Item
...
Monsters' skills Chain # additional times
More Armour Energy Shield or Evasion modifiers; No Life modifiers (Dense Fossil)
More Attack modifiers; Fewer Caster modifiers (Serrated Fossil)
More Caster modifiers; Fewer Attack modifiers (Aetheric Fossil)
More Chaos modifiers; No Lightning modifiers (Aberrant Fossil)
More Cold modifiers; No Fire modifiers (Frigid Fossil)
More Elemental modifiers; No Poison or Bleeding modifiers (Prismatic Fossil)
More Fire modifiers; No Cold modifiers (Scorched Fossil)
More Life modifiers; No Armour Energy Shield or Evasion modifiers (Pristine Fossil)
More Lightning modifiers; No Physical modifiers (Metallic Fossil)
More Mana modifiers; No Speed modifiers (Lucent Fossil)
More Minion and Aura modifiers (Bound Fossil)
More Physical modifiers; No Chaos modifiers (Jagged Fossil)
More Poison or Bleeding modifiers; No Elemental modifiers (Corroded Fossil)
More Socketed Gem Level modifiers (Faceted Fossil)
More Speed modifiers; No Mana modifiers (Shuddering Fossil)
More sockets; Can have white sockets (Encrusted Fossil)
Mortal Conviction
...
Necrotic Footprints 
Nemesis Monsters drop # additional Currency Item
...
Numeric modifier values are lucky; High Level modifiers are more common (Sanctified Fossil)
...
Precision has #% increased Mana Reservation
...
Purity of Elements has #% reduced Mana Reservation
...
Rogue Exiles deal #% increased Damage
Rogue Exiles drop # additional Currency Items
...
Shrines drop a Currency Item when used
...
Socketed Gems are Supported by Level # Culling Strike
Socketed Gems are Supported by Level # Curse On Hit
...
Spectres have a Base Duration of # seconds\nSpectres do not travel between Areas
...
Strongboxes in Area are at least Magic Rarity
...
The first time a Player reaches # Rampage Kills in this Area 6 Currency Items will drop
...
Trigger Level # Bone Offering Flesh Offering or Spirit Offering every 5 seconds\nOffering Skills Triggered this way also affect you
...
Venom Gyre has a #% chance to inflict Withered for 2 seconds on Hit
...
When a Bloodline Pack is Slain it drops a Currency Item
...
With 40 Intelligence in Radius #% of Glacial Cascade Physical Damage\nConverted to Cold Damage
...
With at least 40 Dexterity in Radius Dual Strike has #% increased Attack\nSpeed while wielding a Claw
With at least 40 Dexterity in Radius Dual Strike has #% increased\nAccuracy Rating while wielding a Sword
With at least 40 Dexterity in Radius Dual Strike has #% to Critical Strike\nMultiplier while wielding a Dagger
With at least 40 Dexterity in Radius Dual Strike has a #% chance\nto deal Double Damage with the Main-Hand Weapon
...
With at least 40 Intelligence in Radius #% increased Freezing Pulse Damage if\nyou've Shattered an Enemy Recently
With at least 40 Intelligence in Radius #% of Damage taken gained as Mana over 4 seconds when Hit if you've Warcried Recently
...
With at least 40 Intelligence in Radius Magma Orb deals #% more Damage per Chain
With at least 40 Intelligence in Radius Magma Orb deals #% more Damage
...
With at least 40 Strength in Radius Ground Slam has a #% chance\nto grant an Endurance Charge when you Stun an Enemy
